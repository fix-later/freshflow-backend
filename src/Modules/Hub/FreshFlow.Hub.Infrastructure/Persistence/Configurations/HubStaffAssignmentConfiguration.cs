...
internal sealed class HubStaffAssignmentConfiguration
    : IEntityTypeConfiguration<HubStaffAssignment>
{
    public void Configure(EntityTypeBuilder<HubStaffAssignment> builder)
    {
        builder.ToTable("hub_staff_assignments");

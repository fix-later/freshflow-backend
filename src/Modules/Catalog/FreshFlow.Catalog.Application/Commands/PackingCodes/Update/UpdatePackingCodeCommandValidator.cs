...
internal sealed class UpdatePackingCodeCommandValidator : AbstractValidator<UpdatePackingCodeCommand>
{
    public UpdatePackingCodeCommandValidator(
        ...
        IConfiguration config)
    {
        ...
        RuleFor(x => x.Code)
            ...
            .MustAsync(async (command, code, ct) =>
                !await packingCodes.CodeExistsAsync(code.Trim(), command.Id, ct))

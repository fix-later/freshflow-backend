...
namespace FreshFlow.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260816165433_AddOrderClaimProofImageUrl")]
    partial class AddOrderClaimProofImageUrl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FreshFlow.Hub.Domain.Entities.HubDriverAssignment", b =>
                {
                    b.Property<Guid>("HubId")
                        .HasColumnType("uuid")
                        .HasColumnName("hub_id");
                    ...
                    b.ToTable("hub_driver_assignments", (string)null);
                });
            ...
            modelBuilder.Entity("FreshFlow.Hub.Domain.Entities.HubSortingProgress", b =>
                {
                    ...
                    b.HasIndex("HubId", "ServiceDate", "OrderItemId")
                        .IsUnique()
            ...
            modelBuilder.Entity("FreshFlow.Hub.Infrastructure.CrossModule.HubProcurementItemRow", b =>
                {
                    ...
                    b.Property<decimal?>("PackingCapacityKg")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("FreshFlow.Logistics.Infrastructure.CrossModule.MarketSessionRow", b =>
                {
                    b.Property<Guid>("HubId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FreshFlow.Orders.Domain.Entities.CreditTransaction", b =>
                {
                    ...
                    b.HasIndex("RestaurantId", "Reference")
                        .IsUnique()
                    ...
                    b.ToTable("credit_transactions", null, t =>
                        {
                            t.HasCheckConstraint("ck_credit_transactions_settlement_reference", "type <> 'settlement' OR (reference IS NOT NULL AND btrim(reference) <> '')");
                        });
                });
            ...
            modelBuilder.Entity("FreshFlow.Orders.Domain.Entities.OperationalSettings", b =>
                {
                    ...
                    b.Property<decimal>("RoundingUnit")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric(14,2)")
                        .HasDefaultValue(0m)
                        .HasColumnName("rounding_unit");
            ...
            modelBuilder.Entity("FreshFlow.Orders.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<int?>("DeliveryDistanceMeters")
                        .HasColumnType("integer")
                    ...
                    b.Property<decimal?>("DeliveryOriginLatitude")
                        .HasPrecision(9, 6)
                        .HasColumnType("numeric(9,6)")
                        .HasColumnName("delivery_origin_latitude");

                    b.Property<decimal?>("DeliveryOriginLongitude")
                        .HasPrecision(9, 6)
                        .HasColumnType("numeric(9,6)")
            ...
            modelBuilder.Entity("FreshFlow.Orders.Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.Property<string>("PackingCodeSnapshot")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("packing_code_snapshot");

                    b.Property<decimal?>("PackingWeightKgSnapshot")
                        .HasColumnType("numeric(12,3)")
            ...
            modelBuilder.Entity("FreshFlow.Orders.Domain.Entities.ScheduledOrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("scheduled_order_items", (string)null);
                });
            ...
            modelBuilder.Entity("FreshFlow.Pricing.Domain.Entities.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("PinsToTop")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("pins_to_top");
            ...
            modelBuilder.Entity("FreshFlow.Pricing.Infrastructure.Persistence.MarketProductTagLink", b =>
                {
                    b.Property<Guid>("MarketProductId")
                        .HasColumnType("uuid")
                        .HasColumnName("market_product_id");
                    ...
                    b.HasKey("MarketProductId", "TagId");

                    b.HasIndex("TagId")
                        .HasDatabaseName("idx_market_product_tags_tag_id");
            ...
            modelBuilder.Entity("FreshFlow.Procurement.Domain.Entities.MarketSession", b =>
                {
                    ...
                    b.Property<decimal?>("PlannedCapacityKg")
                        .HasColumnType("numeric(12,3)")
            ...
            modelBuilder.Entity("FreshFlow.Procurement.Domain.Entities.MarketSessionAgent", b =>
                {
                    ...
                    b.ToTable("market_session_agents", (string)null);
                });

            modelBuilder.Entity("FreshFlow.Procurement.Domain.Entities.MarketSessionVehicle", b =>
                {
                    b.Property<Guid>("SessionId")
                        .HasColumnType("uuid")
                        .HasColumnName("session_id");
                    ...
                    b.HasKey("SessionId", "VehicleId");

                    b.HasIndex("VehicleId");

                    b.ToTable("market_session_vehicles", (string)null);
                });
            ...
            modelBuilder.Entity("FreshFlow.Procurement.Infrastructure.CrossModule.MarketSessionTrackingOrderRow", b =>
                {
                    b.Property<DateTime?>("ConfirmedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("FreshFlow.Orders.Domain.Entities.ScheduledOrderItem", b =>
                {
                    b.HasOne("FreshFlow.Orders.Domain.Entities.ScheduledOrder", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("FreshFlow.Pricing.Infrastructure.Persistence.MarketProductTagLink", b =>
                {
                    ...
                    b.HasOne("FreshFlow.Pricing.Domain.Entities.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
